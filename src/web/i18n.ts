...
export const I18N_DICTIONARIES: Record<Locale, Dictionary> = {
  en: {
    ...
    'app.memory': 'Workspace Memory', 'app.runs': 'MoA Runs', 'app.status': 'Agent Status', 'app.tower': 'Tower Workflow', 'app.system': 'System Health',
    ...
    'debate.orchestrator': 'Orchestrator', 'debate.mainAgent': 'Main', 'debate.starting': 'starting…',
    ...
    'board.keyRequired': 'Key is required.', 'board.tooLarge': 'Value exceeds {max} UTF-8 bytes.',
    ...
    'tower.title': 'Tower Workflow', 'tower.polling': 'live · 5s poll', 'tower.connecting': 'connected', 'tower.scanning': 'Scanning workspaces…',
    ...
    'tower.findings': 'Findings', 'tower.reviews': 'Reviews',
    'tower.colMission': 'Mission', 'tower.colTitle': 'Title', 'tower.colKind': 'Kind',
    'tower.colStatus': 'Status', 'tower.colOwner': 'Owner', 'tower.colBranch': 'Branch',
    'tower.colCi': 'CI', 'tower.colReview': 'Review gate',
    'tower.colName': 'Name', 'tower.colVerified': 'Verified', 'tower.colAgentId': 'Agent id',
    'tower.colRole': 'Role', 'tower.colDetail': 'Detail',
    'tower.colDate': 'Date', 'tower.colSeverity': 'Severity', 'tower.colAgent': 'Agent',
    'tower.colRound': 'Round', 'tower.colReviewer': 'Reviewer', 'tower.colMerge': 'Merge', 'tower.colCommit': 'Commit',
    'tower.ciNone': '—', 'tower.ciPass': 'pass', 'tower.ciFail': 'fail', 'tower.ciSkip': 'skipped',
    'tower.ciAt': '{commit} · {time}',
    'tower.reviewNone': 'none',
    'tower.verifiedYes': 'verified', 'tower.verifiedNo': 'unverified',
    'tower.masked': '(masked)',
  ...
  'zh-CN': {
    ...
    'debate.orchestrator': '编排者', 'debate.mainAgent': '主 Agent', 'debate.starting': '启动中…',
    ...
    'app.tower': '塔台工作流',
    'tower.title': '塔台工作流', 'tower.polling': 'live · 5 秒轮询', 'tower.connecting': '已连接', 'tower.scanning': '扫描工作区中…',
    ...
    'tower.findings': '发现', 'tower.reviews': '评审',
    'tower.colMission': '任务', 'tower.colTitle': '标题', 'tower.colKind': '类型',
    'tower.colStatus': '状态', 'tower.colOwner': '属主', 'tower.colBranch': '分支',
    'tower.colCi': 'CI', 'tower.colReview': '评审门禁',
    'tower.colName': '名称', 'tower.colVerified': '已验证', 'tower.colAgentId': 'Agent id',
    'tower.colRole': '角色', 'tower.colDetail': '详情',
    'tower.colDate': '日期', 'tower.colSeverity': '严重度', 'tower.colAgent': '代理',
    'tower.colRound': '轮次', 'tower.colReviewer': '评审', 'tower.colMerge': '合并', 'tower.colCommit': '提交',
    'tower.ciNone': '—', 'tower.ciPass': '通过', 'tower.ciFail': '失败', 'tower.ciSkip': '已跳过',
    'tower.ciAt': '{commit} · {time}',
    'tower.reviewNone': '无',
    'tower.verifiedYes': '已验证', 'tower.verifiedNo': '未验证',
    'tower.masked': '（已掩码）',
