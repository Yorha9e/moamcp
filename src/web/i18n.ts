...
export const I18N_DICTIONARIES: Record<Locale, Dictionary> = {
  ...
  'zh-CN': {
    ...
    'system.copyUrl': '复制控制台 URL', 'system.openDebate': '打开 MOA 辩论', 'system.intro': 'Bus listener 条目不等于全部 Kimi Session / MCP 进程。此页面只读，不提供危险操作。', 'system.unavailable': '系统健康信息暂不可用：', 'system.value': '值',
